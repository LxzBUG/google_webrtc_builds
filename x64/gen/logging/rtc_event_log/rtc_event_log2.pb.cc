...
::google::protobuf::internal::SCCInfo<23> scc_info_EventStream =
    {{ATOMIC_VAR_INIT(::google::protobuf::internal::SCCInfoBase::kUninitialized), 23, InitDefaultsEventStream}, {
